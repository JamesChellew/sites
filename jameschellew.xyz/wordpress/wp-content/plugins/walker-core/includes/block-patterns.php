...
function walker_core_register_pattern_category()
{
    ...
    } elseif ($wc_current_theme == "Dustless") {
        $block_pattern_categories = array(
            'dustless-pro' => array('label' => __('Dustless: Pro Patterns', 'walker-core')),
        );
    } elseif ($wc_current_theme == "Mainfold") {
        $block_pattern_categories = array(
            'mainfold-pro' => array('label' => __('Mainfold: Pro Patterns', 'walker-core')),
        );
    } else {
        $block_pattern_categories = array(
