...
/**
 * Title: About Us Pro
 * Slug: walkercore/mainfold-pro-about-us
 * Categories: mainfold-pro
 */
$mainfold_about_img = array(
    WALKER_CORE_URL . 'admin/images/mainfold/about-us.jpg'
);
?>
...
<main class="wp-block-group has-light-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:100px;padding-right:var(--wp--preset--spacing--40);padding-bottom:100px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained","wideSize":"1180px"}} -->
    <div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"30px","left":"100px"}}}} -->
        <div class="wp-block-columns"><!-- wp:column -->
            <div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url($mainfold_about_img[0]) ?>","id":183,"dimRatio":0,"customOverlayColor":"#8b7d6f","isUserOverlayColor":true,"isDark":false,"style":{"border":{"radius":"10px"}},"className":"mainfold-pro-about-img","layout":{"type":"constrained"}} -->
                <div class="wp-block-cover is-light mainfold-pro-about-img" style="border-radius:10px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#8b7d6f"></span><img class="wp-block-cover__image-background wp-image-183" alt="" src="<?php echo esc_url($mainfold_about_img[0]) ?>" data-object-fit="cover" />
