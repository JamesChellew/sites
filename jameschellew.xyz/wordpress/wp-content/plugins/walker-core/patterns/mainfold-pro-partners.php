...
/**
 * Title: Partners Pro
 * Slug: walkercore/mainfold-pro-partners
 * Categories: mainfold-pro
 */
$mainfold_partners_img = array(
    WALKER_CORE_URL . 'admin/images/mainfold/client-1.png',
    WALKER_CORE_URL . 'admin/images/mainfold/client-2.png',
    WALKER_CORE_URL . 'admin/images/mainfold/client-3.png',
    WALKER_CORE_URL . 'admin/images/mainfold/client-4.png',
    WALKER_CORE_URL . 'admin/images/mainfold/client-5.png'
);
?>
        ...
        <div class="wp-block-group"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"top":"20px","left":"20px"}}}} -->
            <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center"} -->
                <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":570,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
                    <figure class="wp-block-image aligncenter size-full"><img src="<?php echo esc_url($mainfold_partners_img[0]) ?>" alt="" class="wp-image-570" /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:column -->
                ...
                <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":571,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
                    <figure class="wp-block-image aligncenter size-full"><img src="<?php echo esc_url($mainfold_partners_img[1]) ?>" alt="" class="wp-image-571" /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:column -->
                ...
                <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":572,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
                    <figure class="wp-block-image aligncenter size-full"><img src="<?php echo esc_url($mainfold_partners_img[2]) ?>" alt="" class="wp-image-572" /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:column -->
                ...
                <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":573,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
                    <figure class="wp-block-image aligncenter size-full"><img src="<?php echo esc_url($mainfold_partners_img[3]) ?>" alt="" class="wp-image-573" /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:column -->
                ...
                <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":574,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
                    <figure class="wp-block-image aligncenter size-full"><img src="<?php echo esc_url($mainfold_partners_img[4]) ?>" alt="" class="wp-image-574" /></figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:column -->
            </div>
