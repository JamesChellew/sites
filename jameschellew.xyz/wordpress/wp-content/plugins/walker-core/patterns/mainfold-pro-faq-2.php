...
/**
 * Title: FAQ Pro 2
 * Slug: walkercore/mainfold-pro-faq-2
...
<div class="wp-block-group has-white-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:100px;padding-right:var(--wp--preset--spacing--40);padding-bottom:100px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained","wideSize":"1180px"}} -->
    <div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"50px","left":"100px"}}}} -->
        <div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"top"} -->
            <div class="wp-block-column is-vertically-aligned-top"><!-- wp:group {"layout":{"type":"constrained"}} -->
                <div class="wp-block-group"><!-- wp:heading {"level":5,"style":{"typography":{"textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary"} -->
                    <h5 class="wp-block-heading has-secondary-color has-text-color has-link-color" style="text-transform:uppercase"><?php esc_html_e("-FAQ", 'walker-core') ?></h5>
                    <!-- /wp:heading -->

                    <!-- wp:heading {"style":{"typography":{"textTransform":"capitalize"}}} -->
                    <h2 class="wp-block-heading" style="text-transform:capitalize"><?php esc_html_e("Frequently Asked Questions?", 'walker-core') ?></h2>
                    <!-- /wp:heading -->
                    ...
                    <div class="wp-block-buttons"><!-- wp:button {"className":"is-style-button-hover-primary"} -->
                        <div class="wp-block-button is-style-button-hover-primary"><a class="wp-block-button__link wp-element-button"><?php esc_html_e("Contact With Us", 'walker-core') ?></a></div>
                        <!-- /wp:button -->
                    </div>
                    <!-- /wp:buttons -->
                </div>
            ...
            <div class="wp-block-column"><!-- wp:group {"layout":{"type":"constrained"}} -->
                <div class="wp-block-group"><!-- wp:heading {"level":4} -->
                    <h4 class="wp-block-heading"><?php esc_html_e("Can I use Starter Templates with any Theme?", 'walker-core') ?></h4>
                    <!-- /wp:heading -->
                ...
                <!-- wp:separator {"backgroundColor":"foreground-alt","className":"is-style-wide"} -->
                <hr class="wp-block-separator has-text-color has-foreground-alt-color has-alpha-channel-opacity has-foreground-alt-background-color has-background is-style-wide" />
                <!-- /wp:separator -->
