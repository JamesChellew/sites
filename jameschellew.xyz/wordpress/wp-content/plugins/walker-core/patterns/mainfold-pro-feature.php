...
/**
 * Title: Feature Pro
 * Slug: walkercore/mainfold-pro-feature
 * Categories: mainfold-pro
 */
$mainfold_feature_img = array(
    WALKER_CORE_URL . 'admin/images/mainfold/features-img-1.jpg',
    WALKER_CORE_URL . 'admin/images/mainfold/features-img-2.jpg',
    WALKER_CORE_URL . 'admin/images/mainfold/features-img-3.jpg'
);
?>
        ...
        <div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"30px","left":"30px"}}}} -->
            <div class="wp-block-columns"><!-- wp:column {"width":"33%"} -->
                <div class="wp-block-column" style="flex-basis:33%"><!-- wp:group {"style":{"border":{"radius":"10px"},"spacing":{"blockGap":"20px"}},"layout":{"type":"constrained","wideSize":"345px"}} -->
                    <div class="wp-block-group" style="border-radius:10px"><!-- wp:cover {"url":"<?php echo esc_url($mainfold_feature_img[0]) ?>","id":411,"dimRatio":0,"customOverlayColor":"#e3e9d2","isUserOverlayColor":true,"isDark":false,"style":{"dimensions":{"aspectRatio":"1"},"border":{"radius":"10px"}},"className":"mainfold-pro-feature-image","layout":{"type":"constrained"}} -->
                        <div class="wp-block-cover is-light mainfold-pro-feature-image" style="border-radius:10px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#e3e9d2"></span><img class="wp-block-cover__image-background wp-image-411" alt="" src="<?php echo esc_url($mainfold_feature_img[0]) ?>" data-object-fit="cover" />
                ...
                <!-- wp:column {"width":"33%"} -->
                <div class="wp-block-column" style="flex-basis:33%"><!-- wp:group {"style":{"border":{"radius":"10px"},"spacing":{"blockGap":"20px"}},"layout":{"type":"constrained","wideSize":"345px"}} -->
                    <div class="wp-block-group" style="border-radius:10px"><!-- wp:cover {"url":"<?php echo esc_url($mainfold_feature_img[1]) ?>","id":423,"dimRatio":0,"customOverlayColor":"#dfccd1","isUserOverlayColor":true,"isDark":false,"style":{"dimensions":{"aspectRatio":"1"},"border":{"radius":"10px"}},"className":"mainfold-pro-feature-image","layout":{"type":"constrained"}} -->
                        <div class="wp-block-cover is-light mainfold-pro-feature-image" style="border-radius:10px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#dfccd1"></span><img class="wp-block-cover__image-background wp-image-423" alt="" src="<?php echo esc_url($mainfold_feature_img[1]) ?>" data-object-fit="cover" />
                            <div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
                                <p class="has-text-align-center has-large-font-size"></p>
                                <!-- /wp:paragraph -->
                            </div>
                ...
                <!-- wp:column {"width":"33%"} -->
                <div class="wp-block-column" style="flex-basis:33%"><!-- wp:group {"style":{"border":{"radius":"10px"},"spacing":{"blockGap":"20px"}},"layout":{"type":"constrained","wideSize":"345px"}} -->
                    <div class="wp-block-group" style="border-radius:10px"><!-- wp:cover {"url":"<?php echo esc_url($mainfold_feature_img[2]) ?>","id":424,"dimRatio":0,"customOverlayColor":"#d0cc8d","isUserOverlayColor":true,"isDark":false,"style":{"dimensions":{"aspectRatio":"1"},"border":{"radius":"10px"}},"className":"mainfold-pro-feature-image","layout":{"type":"constrained"}} -->
                        <div class="wp-block-cover is-light mainfold-pro-feature-image" style="border-radius:10px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#d0cc8d"></span><img class="wp-block-cover__image-background wp-image-424" alt="" src="<?php echo esc_url($mainfold_feature_img[2]) ?>" data-object-fit="cover" />
                            <div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
                                <p class="has-text-align-center has-large-font-size"></p>
                                <!-- /wp:paragraph -->
                            </div>
