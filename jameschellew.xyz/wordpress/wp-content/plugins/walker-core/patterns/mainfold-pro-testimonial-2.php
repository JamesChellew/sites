    ...
    <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"layout":{"type":"constrained"}} -->
        ...
        <div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"60px","left":"40px"}}}} -->
            <div class="wp-block-columns"><!-- wp:column {"width":"50%","className":"is-style-column-hover-border-secondary"} -->
                <div class="wp-block-column is-style-column-hover-border-secondary" style="flex-basis:50%"><!-- wp:group {"style":{"border":{"radius":"10px"},"spacing":{"padding":{"top":"50px","bottom":"50px","left":"40px","right":"40px"}}},"backgroundColor":"white","className":"mainfold-pro-testimonial-group","layout":{"type":"constrained"}} -->
                    <div class="wp-block-group mainfold-pro-testimonial-group has-white-background-color has-background" style="border-radius:10px;padding-top:50px;padding-right:40px;padding-bottom:50px;padding-left:40px"><!-- wp:image {"id":795,"width":"70px","height":"70px","scale":"cover","sizeSlug":"full","linkDestination":"none","align":"right","className":"mainfold-pro-testimonial-icon"} -->
                        <figure class="wp-block-image alignright size-full is-resized mainfold-pro-testimonial-icon"><img src="<?php echo esc_url($mainfold_testimonial_img[1]) ?>" alt="" class="wp-image-795" style="object-fit:cover;width:70px;height:70px" /></figure>
                        <!-- /wp:image -->
                        ...
                        <div class="wp-block-group"><!-- wp:image {"id":479,"width":"70px","height":"70px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                            <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url($mainfold_testimonial_img[2]) ?>" alt="" class="wp-image-479" style="object-fit:cover;width:70px;height:70px" /></figure>
                            <!-- /wp:image -->
                ...
                <div class="wp-block-column is-style-column-hover-border-secondary" style="flex-basis:50%"><!-- wp:group {"style":{"border":{"radius":"10px"},"spacing":{"padding":{"top":"50px","bottom":"50px","left":"40px","right":"40px"}}},"backgroundColor":"white","className":"mainfold-pro-testimonial-group","layout":{"type":"constrained"}} -->
                    <div class="wp-block-group mainfold-pro-testimonial-group has-white-background-color has-background" style="border-radius:10px;padding-top:50px;padding-right:40px;padding-bottom:50px;padding-left:40px"><!-- wp:image {"id":795,"width":"70px","sizeSlug":"full","linkDestination":"none","align":"right","className":"mainfold-pro-testimonial-icon"} -->
                        <figure class="wp-block-image alignright size-full is-resized mainfold-pro-testimonial-icon"><img src="<?php echo esc_url($mainfold_testimonial_img[1]) ?>" alt="" class="wp-image-795" style="width:70px" /></figure>
                        <!-- /wp:image -->
                        ...
                        <div class="wp-block-group"><!-- wp:image {"id":802,"width":"70px","height":"70px","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
                            <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url($mainfold_testimonial_img[3]) ?>" alt="" class="wp-image-802" style="object-fit:cover;width:70px;height:70px" /></figure>
                            <!-- /wp:image -->
